...
func main() {
	...
	secretId := "AKIDnaN2Xry5SvFQSGfr69AzeFi0EKNJdzFO"
	secretKey := "77BCILLCBHQTVbUXLBWxKmHgzHUgkgXK"
	...
	request := SendSmsRequest{
		SmsSdkAppId:      "1400773224",
		SignName:         "鱼鱼鱼h个人网",
		TemplateId:       "1623984",
		TemplateParamSet: []string{"ywh"},
		PhoneNumberSet:   []string{"+8613634058371"},
		SessionContext:   "test",
	}
	...
	url := fmt.Sprintf(`curl -X POST https://%s\
 -H "Authorization: %s"\
